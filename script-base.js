...
MywebGenerator.prototype.addScriptToIndex = function (script, module) {
  try {
    var appPath = this.env.options.appPath;
    var fullPath = path.join(appPath, 'index.html');
    var sgPath = path.join(appPath, 'styleguide/layouts/default.html')
...
MywebGenerator.prototype.generateSourceAndTest = function (appTemplate, testTemplate, targetDirectory, addIndex, module) {
  ...
  if (addIndex) {
    this.addScriptToIndex(path.join(targetDirectory, this.name), module);
  }
};
